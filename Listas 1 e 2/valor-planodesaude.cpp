...
int main() {
	...
	cout << "\n\t\t\t\t\tQuanto será seu plano de saúde?\n";
	...
	if(idade > 0 && idade < 10){
		cout << "\nSeu plano de saúde custará R$180.";
	}else if(idade >= 10 && idade <= 30){
		cout << "\nSeu plano de saúde custará R$150.";
	}else if(idade >= 31 && idade <= 60){
		cout << "\nSeu plano de saúde custará R$195.";
	}else if(idade > 60 && idade < 100){
		cout << "\nSeu plano de saúde custará R$230.";
	}else{
		cout << "\nIdade inválida";
	}
	cout << "\n\t\t\t\t\tFim de programa\n\n\n\n\n\n";
